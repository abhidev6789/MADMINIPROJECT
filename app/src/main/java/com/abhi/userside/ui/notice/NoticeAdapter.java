package com.abhi.userside.ui.notice;
...
import com.abhi.userside.fullimage.FullImageView;
...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.NoticeViewAdapter> {
    ...
    private ArrayList<com.abhi.userside.ui.notice.NoticeData> list;


    public NoticeAdapter(Context context, ArrayList<com.abhi.userside.ui.notice.NoticeData> list) {
    ...
    public void onBindViewHolder(@NonNull NoticeViewAdapter holder, int position) {
      ...
      final com.abhi.userside.ui.notice.NoticeData currentItem = list.get(position);
