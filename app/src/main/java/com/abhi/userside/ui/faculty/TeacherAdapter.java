package com.abhi.userside.ui.faculty;
...
public class TeacherAdapter extends RecyclerView.Adapter<TeacherAdapter.TeacherViewAdapter> {
    private List<com.abhi.userside.ui.faculty.TeacherData> list;
    private Context context;

    public TeacherAdapter(List<com.abhi.userside.ui.faculty.TeacherData> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull TeacherViewAdapter holder,  int position) {
        ...
        com.abhi.userside.ui.faculty.TeacherData item = list.get(position);
